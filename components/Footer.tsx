...
export default function Footer() {
  ...
  return (
    <footer
      role="contentinfo"
      className="bg-gray-300 border-t border-white/8 py-10 sm:py-12 lg:py-16"
    >
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-8 sm:mb-10 lg:mb-12">
          ...
          <nav aria-label="Programs links">
            <h3 className="text-[#eb4800] font-semibold text-sm mb-3 sm:mb-4 tracking-wide">
              Programs
            </h3>
            <ul className="space-y-2 sm:space-y-2.5">
              {["MBA in Business Management", "PGDM", "Executive MBA", "Certifications", "Online Courses"].map((item) => (
                <li key={item}>
                  <a
                    href="#services"
                    className="text-navy-400 hover:text-[#044dd4] text-sm transition-colors focus:outline-none focus:underline"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <address className="not-italic space-y-2 sm:space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-2 text-navy-400 hover:text-[#044dd4] text-sm transition-colors focus:outline-none focus:underline"
              >
          ...
          <nav className="flex flex-wrap justify-center gap-4 sm:gap-5" aria-label="Legal links">
            {["Privacy Policy", "Terms of Use", "Sitemap"].map((item) => (
              <a
                key={item}
                href="#"
                className="text-navy-500 hover:text-[#044dd4] text-xs transition-colors focus:outline-none focus:underline"
              >
                {item}
              </a>
            ))}
